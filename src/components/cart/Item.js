...
class Item extends Component {
    ...
    handleChange = (e) => {
        ...
        if(e.target.value > this.props.item.product.skus[0].quantityAvailable) {
  ...
  render() {
      ...
      return (
          ...
          <div className="row">
              <div className="col-xs-2"><img className="img-responsive" src={item.product.medias[0].url} />
              </div>
              ...
              <div className="col-xs-6">
                  <div className="col-xs-3 text-right">
                      <h6><strong>{ item.product.retailPrice } <span className="text-muted">x</span></strong></h6>
                  </div>
